...
class Logger(object):
    ...
    def record(self, key, value, step, percentile=False, report=False, molecule=False):
        ...
        with self.writer.as_default():
            ...
            if (step + 1) % 100 == 0 and key == "update/score":
                tf.summary.histogram(key + "/summary", value, step=step)
